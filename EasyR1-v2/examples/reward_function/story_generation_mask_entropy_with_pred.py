...
def compute_score(
    ...
    Args:
        ...
        accuracy_weight: Weight for next_episode accuracy reward
    ...
    for reward_input in reward_inputs:
        ...
        # log_path = "/hpc/home/kai_he/workshop/Story_RL/EasyR1/response_log.txt"
        # with open(log_path, "a", encoding="utf-8") as f:
        #     f.write(ast_str + "\n" + "="*80 + "\n")
        #     f.write(f"is_valid_json:{is_valid_json}")
