...
class ActorConfig:
    ...
    is_story: bool = field(default=True, init=False)
    use_dp_loss: bool = field(default=False, init=False)
    rho: float = field(default=0.2, init=False)
...
class RefConfig:
    ...
    is_story: bool = field(default=False, init=False)
