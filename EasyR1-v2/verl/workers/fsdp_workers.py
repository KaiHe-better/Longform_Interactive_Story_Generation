...
class FSDPWorker(Worker):
    ...
    def _init_dist_mesh(
        ...
        config.global_batch_size_per_device = config.global_batch_size // (
            world_size // config.ulysses_size
        )
    ...
    def init_model(self):
        ...
        #     self.judge_policy = DataParallelPPOActor(
        #         config=self.config.ref,
        #         actor_module=self.ref_fsdp_module,
        #     )
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        output = self.rollout.generate_sequences_r(prompts=prompts)
        ...
        with self.ulysses_sharding_manager:
            ...
            if self.actor.is_story:
                ...
                (
                    ...
                    entropy_wo_r,
                    # info_flow_wo_r,
                ) = self.actor.compute_log_prob(data=data)
                ...
                output = DataProto.from_dict(
                    tensors={
                        ...
                        "old_entropy": entropy,
                        "info_flow": info_flow,
                        "log_probs_wo_r": log_probs_wo_r,
                        "entropy_wo_r": entropy_wo_r,
                        # "info_flow_wo_r": info_flow_wo_r,
                    },
